...
VALUES
	...
	((SELECT BId FROM Benutzer WHERE Benutzername='Gettopunk96'), (SELECT EId FROM Elektroautos WHERE Modellname='VW e-Golf'), 4),
	((SELECT BId FROM Benutzer WHERE Benutzername='Georg'), (SELECT EId FROM Elektroautos WHERE ModellName='VW e-Golf'), 5),
	((SELECT BId FROM Benutzer WHERE Benutzername='XxGruftixX'), (SELECT EId FROM Elektroautos WHERE ModellName='VW e-Golf'), 3),
	...
	((SELECT BId FROM Benutzer WHERE Benutzername='Pascal'), (SELECT EId FROM Elektroautos WHERE ModellName='VW e-Golf'), 4),
	...
	((SELECT BId FROM Benutzer WHERE Benutzername='Griffith'), (SELECT EId FROM Elektroautos WHERE ModellName='VW e-Golf'), 5),
